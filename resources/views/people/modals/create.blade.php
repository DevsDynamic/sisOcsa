...
<div class="modal fade" id="modal-create" tabindex="-1" aria-labelledby="createCustomerLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form id="formCreateCustomer" method="POST" autocomplete="off" enctype="multipart/form-data">
                @csrf
