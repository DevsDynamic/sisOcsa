...
@section('js')
    ...
    <script>
        $(document).ready(function() {    
            ...
            // Configuración del modal de CAMBIO DE ESTADO de registro (activar/inactivar)
            ...
            // Función para CREAR // Manejar el formulario crear registro
            ...
            // Función para cambiar el estado de registro (activar/inactivar) // Manejar el formulario de cambio de estado
