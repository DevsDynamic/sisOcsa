...
<div class="modal fade" id="modal-change-status" tabindex="-1" role="dialog" aria-labelledby="modalChangeStatusLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ¿Está seguro que desea <strong><span class="textstatus"></span></strong> este <span
                    class="entity"></span> con código <strong><span class="textcode"></span></strong>?
            </div>
            <div class="modal-footer">
                <form id="formChangeStatus" method="POST">
                    @csrf
                    <input type="hidden" id="hiddenIDchangeStatus" name="role_id">
