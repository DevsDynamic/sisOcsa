<!-- Modal para cambiar el estado de la empresa -->
<div class="modal fade" id="modal-change-status" tabindex="-1" role="dialog" aria-labelledby="modalChangeStatusLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header ' . $company->status == 1 ? 'btn-danger' : 'btn-success' . '">
            ...
            <div class="modal-footer">
                <form id="formChangeStatus" method="POST">
                    @csrf
                    <input type="hidden" id="hiddenIDchangeStatus" name="company_id">
