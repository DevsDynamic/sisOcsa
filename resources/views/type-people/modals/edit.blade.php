<!-- Modal de Edición de tipo de clientes -->
<div class="modal fade" id="modal-edit" tabindex="-1" aria-labelledby="editTypeCustomerLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form id="formEditTypeCustomer" method="POST" autocomplete="off" enctype="multipart/form-data">
                @csrf      
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" id="hiddenIDtypeCustomer" name="user_id" class="form-control">
                    <br><br>
