...
<div class="row">
 ...
 <div class="col-lg-4">
  <div class="card modern-card"><div class="card-header border-0"><h3 class="card-title font-weight-bold">Estado operativo</h3></div><div class="card-body">
   ...
   <div class="status-row"><span>Último estado</span><span id="last-status" class="badge badge-{{$lastTransmission?->response_status==='SUCCESS'?'success':'secondary'}}">{{ match($lastTransmission?->response_status){'SUCCESS'=>'ACEPTADO','ERROR'=>'RECHAZADO',default=>'PENDIENTE'} }}</span></div>
